...
void setup()
{
  ...
  Serial.println("InicioDoMonitoramento");
...
void loop()
{
  ...
  // Fototransistor de Dentro da Colmeia
    ...
    if (tempoAtual >= tempoAnterior + timeDelay) {
      ...
      Serial.print("\n\n\n\n\n\n\n\n");
      // Fototransistor
      Serial.print("Fora da Colmeia: "); Serial.println(quantasFora);
      Serial.print("Dentro da Colmeia: "); Serial.println(TotalDeAbelhas - quantasFora);
      Serial.print("Total de Abelhas da Colmeia: "); Serial.println(TotalDeAbelhas);

      // DHT11
      Serial.print(temperatura); Serial.print(" C \t");
      Serial.print(umidade); Serial.print("%\t");
      Serial.print(tOrvalho); Serial.print(" C \t ");

      // Fotoresistor
      Serial.print("n* de Luminecencia: "); Serial.println(MMovel);
